<!DOCTYPE html>
<?php
logme('Mengakses Halaman Employe');
?>
<html lang="en">
<head>
  <meta charset="utf-8">
          ...
          <div class="col-12">
              ...
              <div class="card-header">
                ...
                <button type="button" class="btn btn-danger  float-right" data-toggle="modal" data-target="#create-divisi">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add Employe
                </button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                  $query="select *,(select name from tbl_departement where dept_id=tbl_users.dep_id) as dep,(select name from tbl_divisi where div_id=tbl_users.div_id) as divisi from tbl_users order by id_user";
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a type="button" class="btn btn-danger btn-sm" href="proses/employe/emp_delete.php?id=<?php echo md5($id_user);?>">
                      ...
                      <div class="modal-dialog" role="document">
                          <div class="modal-content">
                              <div class="modal-header">
                                  <h4 class="modal-title" id="myModalLabel">Edit Employe</h4>
                              </div>
                              <div class="modal-body">
                                <form data-toggle="validator" action="proses/employe/emp_edit.php" method="POST">
                                  <input type="hidden" name="id" value="<?php echo md5($id_user);?>"></input>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select form-control" name='div'>
                                          <?php
                                          $qdiv="select * from tbl_divisi";
                                          $rdep=mysqli_query($con,$qdiv);
                                          while ($data_div=mysqli_fetch_array($rdep)){
                                          ?>
                                          <option value="<?php echo $data_div['div_id'];?>"<?php if($data_div['div_id']==$data['div_id']){ echo 'selected';}?>><?php echo $data_div['name'];?></option>
                                        <?php }?>
                                        <select>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="dep">Department</label>
                                        <select class="select form-control" name='dep'>
                                          <?php
                                          $qdep="select * from tbl_departement";
                                          $rdep=mysqli_query($con,$qdep);
                                          while ($data_dep=mysqli_fetch_array($rdep)){
                                          ?>
                                          <option value="<?php echo $data_dep['dept_id'];?>"<?php if($data['dep_id']==$data_dep['dept_id']){ echo 'selected';}?>><?php echo $data_dep['name'];?></option>
                                        <?php }?>
                                        <select>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="user_level">Level</label>
                                        <select class="select form-control" name='user_level'>
                                          <option value="admin"<?php if($data['user_level']=='admin'){ echo 'selected';}?>>Admin</option>
                                          <option value="user" <?php if($data['user_level']=='user'){ echo 'selected';}?>>User</option>
                                        <select>
                                    </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form data-toggle="validator" action="proses/employe/emp_save.php" method="POST">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select form-control" name='div'>
                                      ...
                                      while ($data_div=mysqli_fetch_array($rdep)){
                                      ?>
                                      <option value="<?php echo $data_div['div_id'];?>"><?php echo $data_div['name'];?></option>
                                    <?php }?>
                                    <select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="select form-control" name='dep'>
                                      ...
                                      while ($data_dep=mysqli_fetch_array($rdep)){
                                      ?>
                                      <option value="<?php echo $data_dep['dept_id'];?>"><?php echo $data_dep['name'];?></option>
                                    <?php }?>
                                    <select>
                                </div>
                                <div class="form-group">
...
$(document).ready(function(){
    $('#email').blur(function(){
        ...
        $.ajax({
            type    : 'POST',
            url     : 'proses/employe/cek_username.php',
            data    : 'email='+email,
